...
def read_anchor_file(file, return_uttid=False):
    ...
    with open(file, "r") as f:
        ...
        uttid = lines[0].strip().split(" ")[0]
        ref = lines[0].strip().split(" ")[2:]
        hyp = lines[1].strip().split(" ")[2:]
        op = lines[2].strip().split(" ")[2:]
        csid = lines[3].strip().split(" ")[2:]

    if return_uttid:
        return uttid, ref, hyp, op, csid
