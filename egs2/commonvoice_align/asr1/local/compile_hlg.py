...
def compile_HLG(lang_dir: str,
    ...
    if Path(f"{graph_dir}/G_{ngram_num}_gram.pt").is_file():
        logging.info(f"Loading pre-compiled G_{ngram_num}_gram")
        d = torch.load(f"data/lm/G_{ngram_num}_gram.pt")
