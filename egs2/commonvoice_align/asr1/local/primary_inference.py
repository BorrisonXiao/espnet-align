...
def inference(
    ...
    ngrams = {}
    # Load ngram LMs
    for mid in os.listdir(ngram_dir):
        ngrams[mid] = os.path.join(ngram_dir, mid, inference_ngram)
    ...
    speech2text_kwargs = dict(
        ...
        lm_file=lm_file,
        ngram_file=ngrams[list(ngrams.keys())[0]],
    ...
    speech2text = (list(ngrams.keys())[0], Speech2Text.from_pretrained(
        model_tag=model_tag,
        **speech2text_kwargs,
    ))
        ...
        for keys, batch in loader:
            ...
            try:
                ...
                if speech2text[0] != batch_mid:
                    logging.info(f"Loading ngram model {ngrams[batch_mid]}...")
                    speech2text_kwargs["ngram_file"] = ngrams[batch_mid]
                    speech2text = (batch_mid, Speech2Text.from_pretrained(
                        model_tag=model_tag,
                        **speech2text_kwargs,
                    ))
